        ...
        <div className="content">
          <div className="col-1">
            ...
            <p>
              ...
              Reprehenderit eum nostrum quod adipisci quo velit voluptates enim
              quam delectus. Accusantium?
            </p>
            <div className="used-by">
              <p>USED BY</p>
              <div className="icons">
                <i>
                  <FaDatabase /> Lorem, ipsum.
                </i>
                <i>
                  <FaAsterisk /> Lorem, ipsum.
                </i>
                <i>
                  <FaAccusoft /> Lorem, ipsum.
                </i>
              </div>
            </div>
          </div>
